# Contributing to slides-deal-with-git
...
In short, when you submit code changes, your submissions are understood to be under the same [Creative Commons Attribution 4.0 International](https://github.com/timo-reymann/timo-reymann/slides-deal-with-git/blob/main/LICENSE) that covers the project. Feel free to contact the maintainers if that's a concern.
